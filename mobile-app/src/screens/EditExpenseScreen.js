...
export default function EditExpenseScreen() {
  ...
  const [date, setDate] = useState(
    expenseToEdit.date ? formatDate(expenseToEdit.date, 'short') : new Date().toLocaleDateString('es-MX')
  );
  const [receipts, setReceipts] = useState(expenseToEdit.receipts || []);
  ...
  const handleSave = () => {
    ...
    // Actualizar el gasto en el store
