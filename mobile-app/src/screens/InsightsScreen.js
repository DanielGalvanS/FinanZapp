      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={handleViewAllBudgets}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={handleViewAllGoals}>
              <Text style={[TYPOGRAPHY.body, styles.seeAllText]}>Ver todo</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.reportsGrid}>
            <TouchableOpacity style={[CARD_STYLES.minimal, styles.reportCard]} activeOpacity={0.7} onPress={handleViewReports}>
